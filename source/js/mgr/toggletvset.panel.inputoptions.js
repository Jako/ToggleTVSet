            ...
            listeners: {
                afterrender: function () {
                    this.getEl().select('img').on('click', function () {
                        var msg = '<span style="display: inline-block; text-align: center;">&copy; 2015-2022 by Patrick Percy Blank <a href="https://github.com/pepebe" target="_blank">github.com/pepebe</a><br>' +
